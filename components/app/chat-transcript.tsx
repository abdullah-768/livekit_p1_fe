...
export function ChatTranscript({
  ...
  const renderImageEntry = (imageEntry: ImageEntry) => (
    ...
    >
      <div className="mr-auto max-w-[85%] rounded-2xl bg-gradient-to-br from-[oklch(0.95_0.03_180)] to-[oklch(0.92_0.05_150)] p-3 shadow-md border-2 border-[oklch(0.85_0.1_180)]">
        ...
        <img
          ...
          className="w-full max-w-md rounded-xl border border-[oklch(0.88_0.08_180)] bg-white object-contain shadow-sm cursor-pointer hover:opacity-90 transition-opacity"
        />
      </div>
    </MotionImage>
  );
      ...
      <AnimatePresence>
        {!hidden && (
          <MotionContainer {...CONTAINER_MOTION_PROPS} {...props}>
            ...
            {imageHistory
              .filter(img => img.insertAfterMessageIndex < 0 || img.insertAfterMessageIndex >= messages.length)
